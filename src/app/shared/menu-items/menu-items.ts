...
const MENUITEMS = [
  {
    ...
    main: [
      ...
      {
        state : 'define_partners',
        short_label:'DP',
        name  :'Define Partners',
        type : 'sub',
        icon : 'icon-home',
        children:[
          {
  ...
  },
  {
    ...
    main: [
      ...
      },
      {
        ...
        short_label: 'D',
        name: 'Documentation',
        external: 'http://html.phoenixcoded.net/mega-able/doc-angular-5',
        type: 'external',
        icon: 'icon-file',
        target: true
      }
    ...
    main: [
      {
        ...
        short_label: 'D',
        name: 'Documentation',
        external: 'http://html.phoenixcoded.net/guru-able/doc-angular-4',
        type: 'external',
        icon: 'icon-file',
        target: true
      },
